...
var STACK_BASE = 16123072, STACK_MAX = 21365952, DYNAMIC_BASE = 21365952, DYNAMICTOP_PTR = 16123040;
...
var wasmBinaryFile = "SpeedSenseBase.wasm";
...
var ASM_CONSTS = [ function() {
 ...
 try {
  playAudioJS(UTF8ToString($0), $1, $2, $3);
 } catch (e) {
  console.info("Error playAudioJS:", e);
 }
}, function($0, $1, $2, $3, $4) {
 try {
  playContiniousAudioJS($0, UTF8ToString($1), $2, $3, $4);
 } catch (e) {
  console.info("Error playContiniousAudioJS:", e);
 }
}, function($0, $1, $2, $3, $4, $5) {
 try {
  modifyContiniousAudioJS($0, $1, UTF8ToString($2), $3, $4, $5);
 } catch (e) {
  console.info("Error modifyContiniousAudioJS:", e);
 }
}, function() {
 try {
  muteAllAudioJS();
 } catch (e) {
  console.info("LoadingAPIReady");
 }
}, function() {
 try {
  notifyLoadingAPIReady();
 } catch (e) {
  console.info("LoadingAPIReady");
 }
}, function() {
 try {
  notifyGameplayAPIStart();
 } catch (e) {
  console.info("GameplayAPIStart");
 }
}, function() {
 try {
  notifyGameplayAPIStop();
 } catch (e) {
  console.info("GameplayAPIStop");
 }
}, function() {
...
function _emscripten_asm_const_iiiiddi(code, a0, a1, a2, a3, a4, a5) {
 return ASM_CONSTS[code](a0, a1, a2, a3, a4, a5);
}
...
function _emscripten_asm_const_iiiddi(code, a0, a1, a2, a3, a4) {
 return ASM_CONSTS[code](a0, a1, a2, a3, a4);
}
...
var ___tm_current = 16122896;

var ___tm_timezone = (stringToUTF8("GMT", 16122944, 4), 16122944);
...
var asmLibraryArg = {
 ...
 "_emscripten_asm_const_iiddi": _emscripten_asm_const_iiddi,
 "_emscripten_asm_const_iii": _emscripten_asm_const_iii,
 "_emscripten_asm_const_iiiddi": _emscripten_asm_const_iiiddi,
 "_emscripten_asm_const_iiii": _emscripten_asm_const_iiii,
 "_emscripten_asm_const_iiiiddi": _emscripten_asm_const_iiiiddi,
...
var real__DisableSound = asm["_DisableSound"];

asm["_DisableSound"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__DisableSound.apply(null, arguments);
};

var real__EnableSound = asm["_EnableSound"];

asm["_EnableSound"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__EnableSound.apply(null, arguments);
};
...
var _DisableSound = Module["_DisableSound"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["_DisableSound"].apply(null, arguments);
};

var _EnableSound = Module["_EnableSound"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["_EnableSound"].apply(null, arguments);
};
